...
class ExtractTextTTP extends BasicBolt {
    ...
    async receive(message, stream_id, callback) {
            ...
            const request = new Promise((resolve, reject) => {
                ...
                self._timeoutObject = setTimeout(() => {
                    rp({
                        ...
                        qs: Object.assign(Object.assign({}, self._options), { id }),
                        json: true
                    })
        ...
        if (Object.keys(self._TTPLanguages).includes(documentLanguage)) {
            ...
            const options = Object.assign(Object.assign({}, self._options), { manifest: {
                ...
                for (let lang of languages) {
                    ...
                    for (let format of formats) {
                        ...
                        let request = rp({
                            ...
                            qs: Object.assign(Object.assign({}, self._options), { id: external_id, format,
                                lang }),
                        });
                        // store it for later
