...
class StorePGUserActivities {
    ...
    receive(message, stream_id, callback) {
        let self = this;
        // get sent values
        const { uuid, url, provider, referrer: referrer_url, visitedOn: timestamp, userAgent: user_agent, language } = message;
        // /////////////////////////////////////////
        ...
        const urlPromise = new Promise((resolve, reject) => {
            self._pg.select({ token: provider }, "providers", (e, res) => {
                ...
                let urls = Object.assign({ url }, (provider_id && { provider_id }));
