...
// basic bolt template
const basic_bolt_1 = require("./basic-bolt");
// import textract module from library
const textract = require("@library/textract");
class ExtractTextRaw extends basic_bolt_1.default {
    constructor() {
        super();
        this._name = null;
        this._onEmit = null;
    ...
    init(name, config, context, callback) {
        ...
        const { preserve_line_breaks, preserve_only_multiple_line_breaks, include_alt_text } = config.textract_config;
        // configuration for textract
        this._textractConfig = Object.assign(Object.assign(Object.assign({}, preserve_line_breaks && { preserveLineBreaks: preserve_line_breaks }), preserve_only_multiple_line_breaks && { preserveOnlyMultipleLineBreaks: preserve_only_multiple_line_breaks }), include_alt_text && { includeAltText: include_alt_text });
        callback();
    }
    heartbeat() {
