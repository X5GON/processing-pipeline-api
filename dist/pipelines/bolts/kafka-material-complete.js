...
class KafkaMaterialComplete {
    ...
    receive(material, stream_id, callback) {
        ...
        const { title, description, provider_uri, material_url, authors, language: origin_language, creation_date, retrieved_date, type, mimetype, material_metadata: { wikipedia_concepts, transcriptions, raw_text, metadata, ttp_id }, provider: { token: provider_token }, license } = material;
        // /////////////////////////////////////////
        ...
        // /////////////////////////////////////////
        const message = {
            oer_materials: Object.assign({ title,
                description, language: origin_language, authors: authors_copy, creation_date,
                retrieved_date, type: type.toLowerCase(), mimetype: mimetype.toLowerCase(), license,
                ttp_id }, metadata && { metadata }),
            material_contents,
            features_public,
            urls: {
                provider_uri,
