...
class ExtractVideoTTP extends BasicBolt {
    ...
    async receive(message, stream_id, callback) {
            ...
            const request = new Promise((resolve, reject) => {
                ...
                self._timeoutObject = setTimeout(() => {
                    rp({
                        ...
                        qs: Object.assign(Object.assign({}, self._TTPOptions), { id }),
                        json: true
                    })
        ...
        if (Object.keys(self._TTPLanguages).includes(documentLanguage)) {
            ...
            const options = Object.assign(Object.assign({}, self._TTPOptions), { manifest: {
                    media: {
            ...
            try {
                ...
                const { process_completed, status_code_msg, process_id, status_code } = await _checkTTPStatus(id);
                ...
                for (let lang of languages) {
                    ...
                    for (let format of formats) {
                        ...
                        let request = rp({
                            ...
                            qs: Object.assign(Object.assign({}, self._TTPOptions), { id: external_id, format,
                                lang }),
                        });
                        // store it for later
