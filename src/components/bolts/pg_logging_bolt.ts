...
class PGLoggingBolt extends BasicBolt {
    ...
    async init(name: string, config: Interfaces.IPGLoggingBoltConfig, context: any) {
        this._name = name;
        this._context = context;
        this._onEmit = config.onEmit;
        this._prefix = `[PGLoggingBolt ${this._name}]`;
...
const create = () => new PGLoggingBolt();
