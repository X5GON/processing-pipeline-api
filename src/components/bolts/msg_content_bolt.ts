...
class MsgContentBolt extends BasicBolt {
    ...
    async init(name: string, config: Interfaces.IMsgContentBoltConfig, context: any) {
        this._name = name;
        this._context = context;
        this._onEmit = config.onEmit;
        this._prefix = `[MsgContentBolt ${this._name}]`;
...
const create = () => new MsgContentBolt();
