...
class MessageLogging extends BasicBolt {
    ...
    async init(name: string, config: Interfaces.IMessageLoggingConfig, context: any) {
        this._name = name;
        this._context = context;
        this._onEmit = config.onEmit;
        this._prefix = `[MessageLogging ${this._name}]`;
...
const create = () => new MessageLogging();
